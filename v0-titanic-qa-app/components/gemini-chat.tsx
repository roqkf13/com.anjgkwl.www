        ...
        {messages.length === 0 && (
          <div className="text-center text-gray-500 dark:text-gray-400 py-10 px-2">
            ...
            <p className="text-xs mt-2 leading-relaxed">
              FastAPI 백엔드(<code className="text-[11px] bg-gray-100 dark:bg-gray-700 px-1 rounded">{apiBaseUrl}</code>
              )가 실행 중이어야 합니다. <code className="text-[11px] bg-gray-100 dark:bg-gray-700 px-1 rounded">backend/.env</code>
              에 <code className="text-[11px] bg-gray-100 dark:bg-gray-700 px-1 rounded">GEMINI_API_KEY</code> 를 넣으세요.
            </p>
          </div>
        )}
